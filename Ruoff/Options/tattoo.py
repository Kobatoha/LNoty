...
async def about_tattoo(message: types.Message):
    try:
        ...
        text = 'Нанесение узора и прокачка скрытой силы - рутина, которая неслабо бустит внутрянку персонажа. '\
               ...
               'за 3кк адены~~ в L магазине. Так было ровно до момента выхода апдейта Высшие Эльфы.' \
               'Сейчас же Усилитель Скрытой Силы можно безгранично приобретать в L магазина за 20кк аден. Но качать ' \
               'все равно надо!'
