...
async def announcement():
    ...
    for user in users:
        text = 'Добречка! Сегодня во время профилактики добавили ивент про пиратов - обновила /event,' \
               ' ставьте напоминалочку, там хорошая экспа и можно позакрывать коллекцию, рекомендую\n' \
               '\n' \
               '~ ваша kobatoha'
        try:
